...
class AddToCartFromFavUseCase {
  final BaseFavoriteRepository baseFavoriteRepository;

  AddToCartFromFavUseCase({required this.baseFavoriteRepository});
  Future<Either<Failure, FavoriteOperationEntity>> call(
      int userId, int itemId) async {
    return await baseFavoriteRepository.addToCartFromFavorite(userId, itemId);
  }
}
