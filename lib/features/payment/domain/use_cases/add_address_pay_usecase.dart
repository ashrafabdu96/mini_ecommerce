...
class AddAddressPayUseCase {
  final BasePaymentRepository basePaymentRepository;

  AddAddressPayUseCase({required this.basePaymentRepository});
  Future<Either<Failure, Unit>> call(
      {required AddressEntity addressEntity}) async {
    return await basePaymentRepository.addAddress(addressEntity: addressEntity);
  }
}
